...
abstract class ThemesMarvel {
  ...
  static ThemeData get light {
    return customTheme(
      ...
      surface: ColorsMarvel().red,
      onSurface: ColorsMarvel().black,
      error: ColorsMarvel().red,
      onError: ColorsMarvel().white,
      disabledColor: ColorsMarvel().black.withOpacity(.38),
  ...
  static ThemeData get dark {
    return customTheme(
      ...
      surface: ColorsMarvel().black.shade800,
      onSurface: ColorsMarvel().white,
      error: ColorsMarvel().red,
