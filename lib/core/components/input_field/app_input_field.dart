...
class AppFormInputFieldWithIcon extends StatelessWidget {
  const AppFormInputFieldWithIcon(
      {super.key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      child: Column(
        ...
        children: [
          // Padding(
          //   padding: const EdgeInsets.only(left: 21, bottom: 1),
          //   child: AppText.textPrimary(text: labelText, fontWeight: FontWeight.w600),
          // ),
          TextFormField(
            cursorColor: AppThemes.primaryRegular,
            style: styleMain ??   TextStyle(color: AppThemes.textPrimary, fontSize: 15),
            maxLength: maxLength,
            onTap: onTap,
            decoration: InputDecoration(
              ...
              hintText: labelText,
              hintStyle:  TextStyle(color: AppThemes.textPrimary.withOpacity(0.5)),
              ...
              label: AppText.subTitle(text: labelText, fontWeight: FontWeight.w600),
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: Container(
                      height: 28,
                      width: 28,
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(9), color: AppThemes.primaryRegular.withOpacity(0.2)),
                      child: Padding(
